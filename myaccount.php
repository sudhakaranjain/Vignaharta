...
if(isset($_GET['confirm'])){
					 ...
					 if($_GET['confirm']==1)
					{
						echo	'<div id="msg" title="Registration Successful">
								<span style=" color:red"><b>Please Login to order a movie or add it to your cart or view your cart.
								If you dont have an account <a href="register.php"> click here </a>to register.
									</b></span>
								</div>';
					}
					}
?>
	...
	<div id="outercontainer">
        ...
        <div id="outerheader">
			...
			{?>
			 <li style="float:right"><a href="myaccount.php"><?php echo '<font face="verdana" color="yellow">'.$_SESSION['username'].'</font>';?> Logout</a></li>
			<?php
			}
			else
			{?>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="headertitle twelve columns">
                                ...
                                <span class="pagedesc">Please fill in the form below with your account information.
